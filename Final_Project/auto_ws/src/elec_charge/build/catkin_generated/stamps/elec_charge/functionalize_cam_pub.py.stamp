...
class CamMotorControl:
    ...
    def Switching_Normal_IR_Zeroturn_mode_1(self, roi, cx, approx, width, offset, top_x_distance, bottom_x_distance, top_two_points, bottom_two_points):
        if len(top_two_points) == 2:
            print(f"len of approx : {self.len_approx}")
            ...
            elif (self.len_approx > 4) and (len(self.zero_turn_arr) > 0) and self.available_switch_to_ir and (top_x_distance > bottom_x_distance):
            ...
            elif self.len_approx > 4 and self.available_switch_to_ir == False:
